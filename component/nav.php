  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="home.php">
        <img style="width:6vw; height:10vh; padding-top:-5vh;" alt="Brand" src="asset/img/logo.png">
      </a>
    </div>
    <ul class="nav navbar-nav navbar-right">
      ...
      <li style="border-left: 2px">
      <?php 
        $conn = mysqli_connect('localhost', 'root', '', 'kbs');
        if(isset($_SESSION['idUser'])){
          echo '
          <a class="not-active" href="datab.php" data-toggle="tooltip" data-placement="bottom" title="datav"  ><i class="btn btn-info" id="datav"><b>Confir Barang</b></i></a>
      ';
  } else {
    echo '
          <a class="not-active" href="#" data-toggle="tooltip" data-placement="bottom" title="confirmasi pengambilan barang"  ><i class="btn btn-info" id="datav"><b>Valikasi Barang</b></i></a>
      ';
  }
      ?>
      </li>
...
<div class="container-fluid kategori">
  <div class="row">
    <div class="col-xs-2 col-xs-offset-2">
      <a href="home.php"><img style="width:6vw; height:10vh; padding-top:-2vh;" alt="Brand" src="asset/img/logo.png"></a>
    </div>
    <div class="col-xs-6">
      <ul class="nav nav-pills kategori2">
        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Kategori<span class="caret" style="margin-left:10px"></span></a>
          <ul class="dropdown-menu">
            <li><a data-toggle="pill" href="#umbi">Umbi-Umbian</a></li>
            <li><a data-toggle="pill" href="#biji">Biji-Bijian</a></li>
          </ul>
        </li>
        <li><a data-toggle="pill" href="#buah">Buah-Buahan</a></li>
        <li><a data-toggle="pill" href="#sayur">Sayur-Mayur</a></li>
        <li><a data-toggle="pill" href="#lain">Lain-lain</a></li>
      </ul>
    </div>
  </div>
</div>
