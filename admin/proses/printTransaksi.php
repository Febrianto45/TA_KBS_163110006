...
<button type="button" class="btn btn-success" class="print" onclick="return confirm('Yakin Data Akan Di Print');">
<a href="cetakTransaksi.php" target="_blank" style="text-decoration:none">CETAK</a></button>
<button> <a href="../perid/index.php" onclick = "return confirm('Yakin PerID Data Akan Di Print');" class="btn btn-success btn-md" target="_blank" style="text-decoration:none">CETAK PERID</a></button>
<button> <a href="../report_pdf_date/index.php" onclick = "return confirm('Yakin Cetak Data Perode Akan Di Print');" class="btn btn-success btn-md" target="_blank" style="text-decoration:none">CETAK PERODE</a></button>
<button> <a href="../admin.php" class="btn btn-success btn-md" style="text-decoration:none">Kembali</a></button>
