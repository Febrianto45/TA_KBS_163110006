      ...
      <div class="col-xs-8 col-xs-offset-2">
        <div class="table-responsive">
          <table class="table">
            <thead>
              <tr>
                <h3 style="font-family: Forte; color:0"><strong>Keranjang Belanja</strong></h3>
              </tr>
            </thead>
            <tbody>
              <?php
              ...
              if ($jumlah > 0) {
                ...
                while ($arrayTrolly = mysqli_fetch_array($query_trolly)) {
                  $queryBarang = mysqli_query($conn, "SELECT * FROM tabel_barang WHERE idBarang='$arrayTrolly[idBarang]'");
                  $arrayBarang = mysqli_fetch_array($queryBarang);
                  echo '
                <tr>
                  <td><img src="admin/proses/' . $arrayBarang['path'] . '"></td>
                  <td>
                    <h4><strong>' . $arrayBarang['namaBarang'] . '</strong></h4>
                    <h5><strong>Harga</strong><span class="titik-harga">:</span> Rp.' . $arrayBarang['harga'] . '</h5>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="harga" value="' . $arrayBarang['harga'] . '">
                        <input type="hidden" name="idTrolly" value="' . $arrayTrolly['idTrolly'] . '">
                        <input type="number" value="' . $arrayTrolly['jumlah'] . '" name="jumlah" min="1" max="' . $arrayBarang['stock'] . '" style="margin-left:-1vw">
                        </div>
                      </form>
